...
namespace LogEm
{
    ...
    internal sealed class RequestLogPage : RequestPageBase
    {
        private int _pageIndex;
        private int _pageSize;
        private int _totalCount;
        private ArrayList _requestEntryList;
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            _requestEntryList = new ArrayList(_pageSize);
            _totalCount = this.RequestLog.GetRequests(_pageIndex, _pageSize, _requestEntryList);
        ...
        private void RenderStats(HtmlTextWriter writer)
        {
            ...
            int lastErrorNumber = firstErrorNumber + _requestEntryList.Count - 1;
        ...
        private void RenderErrors(HtmlTextWriter writer)
        {
            ...
            for (int errorIndex = 0; errorIndex < _requestEntryList.Count; errorIndex++)
            {
                ...
                //bodyRow.Cells.Add(FormatCell(new TableCell(), request.HostName, "host-col"));
                //bodyRow.Cells.Add(FormatCell(new TableCell(), request.StatusCode.ToString(), "code-col", Mask.NullString(HttpWorkerRequest.GetStatusDescription(error.StatusCode))));
                ...
                //bodyRow.Cells.Add(FormatCell(new TableCell(), request.User, "user-col"));
                //bodyRow.Cells.Add(FormatCell(new TableCell(), request.Time.ToShortDateString(), "date-col",
                //    request.Time.ToLongDateString()));
                //bodyRow.Cells.Add(FormatCell(new TableCell(), request.Time.ToShortTimeString(), "time-col",
                //    request.Time.ToLongTimeString()));
